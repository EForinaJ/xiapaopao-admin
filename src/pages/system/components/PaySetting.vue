<template>
    <div class="setting">
        ...
        <!-- <div class="setting-item">
            <div class="setting-input">
                <span>兑换积分选项</span>
                <a-checkbox-group v-model="integral" :options="payOptions"   />
            </div>
            <p>请设置充值选项内容</p>
        </div> -->
        ...
        <div class="setting-item">
            ...
            <p>默认 0.005 （千分之五），如果网站不抽成，请设置为0。</p>
        </div>
        <div class="setting-item">
            <div class="setting-input">
                <span>最小提现金额</span>
                <a-input-number class="setting-content" 
                 v-model="withdrawMoneyMin" 
        ...
        <div class="setting-item">
            <div class="setting-input">
                <span>提现服务费</span>
                <a-input-number class="setting-content"  
                v-model="withdrawMoneyServicePercent" 
                  :min="0" :max="1" :precision="3"/>
            </div>
            <p>默认 0.005 （千分之五），如果不收取服务费，请设置为0。</p>
        </div>
...
export default {
    data(){
        return{
            ...
            integral:[],
            withdrawMoneyMin:50,
            withdrawMoneyServicePercent:0.05,
            servicePercent:0.05,
            options: [
                { label: '支付宝', value: 1 },
                { label: '微信', value: 2 },
    ...
    methods:{
        ...
        async getData(){
            ...
            if (res.data.info != null) {
                ...
                this.withdrawMoneyMin = value.withdrawMoneyMin
                this.withdrawMoneyServicePercent = value.withdrawMoneyServicePercent
            ...
            this.$confirm({
                ...
                onOk:() => {
                    const options = {
                        ...
                        withdrawMoneyMin: this.withdrawMoneyMin,
                        withdrawMoneyServicePercent: this.withdrawMoneyServicePercent,
