    ...
    <div class="setting">
        ...
        <div class="setting-item">
            <div class="setting-input">
                <span>登录注册方式</span>
                    <a-radio-group v-model="loginRegisterMode" class="setting-input">
                    <a-radio value="email">
                        邮箱
                    </a-radio>
                    <a-radio value="phone">
    ...
    methods:{
        ...
        async getData(){
            ...
            if (res.data.info != null) {
                ...
                this.loginRegisterMode=value.loginRegisterMode
        ...
        handleSubmit(){
            this.$confirm({
                ...
                onOk:() => {
                    const options = {
                        loginRegisterMode: this.loginRegisterMode,
