<template>
    <div class="container">
        <a-space class="container-action" size="large">
            <a-button v-action="'/media/upload'" class="form-button" @click="uploadImage" size="large" type="primary">
                上传图片
            </a-button>
            <a-button v-action="'/media/upload'" class="form-button" @click="uploadAudio" size="large" type="primary">
                上传音频
            </a-button>
            <a-button v-action="'/media/upload'" class="form-button" @click="uploadVideo" size="large" type="primary">
                上传视频
            </a-button>
            <a-button v-action="'/media/upload'" class="form-button" @click="uploadOther" size="large" type="primary">
                上传其他类型文件
            </a-button>
            <a-button v-action="'/media/remove'" size="large" :disabled="selectedRowKeys.length > 0 ? false :true" @click="batchRemove" type="danger">
                批量删除
            </a-button>
        </a-space>
        <a-table 
